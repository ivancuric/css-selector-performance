...
Instead, focus on making your CSS maintainable and readable. Your colleagues and your future self will thank you for it. Try to optimize the CSS delivery by including only the used styles. And after that - get to know the rendering pipeline. Unlike selectors, styles themselves _can_ be expensive, and the difference between a janky 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU0ODI1NzM0N119
-->