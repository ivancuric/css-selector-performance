...
You _should_ however stick to using classes whenever possible, and adopt some sort of namespacing convention like BEM, SMACSS, OOCSS since it will not only help your website's performance but vastly help with code maintainability. Compound selectors, especially when used with tag and universal sele
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNDg0NzUzMDJdfQ==
-->