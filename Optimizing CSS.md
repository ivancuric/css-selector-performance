...
What we can see from this test is that it's not really worth it to worry over CSS selector performance - just don't overdo it with 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MTY1Njk5ODFdfQ==
-->