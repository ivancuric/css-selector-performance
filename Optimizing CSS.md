...
After constructing the DOM and CSSOM, the browser needs to combine the two into a render tree before finally painting it on the screen. In that step, the browser needs to calculate the final, calculated CSS. You can see this yourself in the inspect panel of the Developer Tools. Basically, 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ5MTUwMTMwM119
-->