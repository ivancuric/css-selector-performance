...
Even  in such an extreme case, with 50000 elements to match, and using some really insane selectors like the last one, we find that the slowest one is ~20ms, while the fastest is the simple class at ~3.5ms. Not really that much of a difference. In a more "tame" DOM, with around 1000 - 5000 nodes, you can expect those 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMzOTU3MDI4Nl19
-->