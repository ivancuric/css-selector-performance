...
After constructing the DOM and CSSOM, the browser needs to combine the two into a render tree before finally painting it on the screen. First, the browser needs 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkzNDUzMjgwMF19
-->