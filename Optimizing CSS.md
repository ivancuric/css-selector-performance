...
This complicates things, since parsing CSS in only a single step in the browser rendering pipeline. Here's a render-oriented
<figure>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NTMzNDg3NDZdfQ==
-->