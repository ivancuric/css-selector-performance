...
What we can see from this test is that it's not really worth it to worry over CSS selector performance - just don't overdo it with pseudoselectors and really long selectors. You should however stick to using classes whenever possible, and adopt
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg1ODk5MDI5OF19
-->