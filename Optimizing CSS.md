...
If you want to learn more about how the browsers parse CSS, check out [Ilya Grigorik's article on how Blink does it](https://developers.google.com/web/fundamentals/performance/critical-rendering-path/constructing-the-object-model) , or Lin Clark's article on Mozilla's new Servo 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MzcwMjUzMzZdfQ==
-->