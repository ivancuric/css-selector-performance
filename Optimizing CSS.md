...
This complicates things, since parsing CSS in only a single step in the browser rendering pipeline. Here's a render-oriented view of how a browser renders  a single frame 
<figure>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjgyODcxMzU0XX0=
-->